...
CREATE TABLE contracts (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    rental_id UUID UNIQUE REFERENCES rentals(id) ON DELETE RESTRICT,
    tenant_id UUID NOT NULL REFERENCES tenants(id) ON DELETE RESTRICT,
...
-- NOTE: This table should be partitioned by date (e.g., PARTITION BY RANGE (created_at))
-- to ensure high performance and manageable storage as the system scales.
...
export const MOCK_RENTALS: Rental[] = [
  { id: '101', clientName: 'Alice Smith', vehicleId: '1', startDate: '2023-10-25', endDate: '2023-10-30', duration_days: 5, status: 'Active', total_amount: 450 },
  { id: '102', clientName: 'Bob Jones', vehicleId: '5', startDate: '2023-10-20', endDate: '2023-11-05', duration_days: 16, status: 'Active', total_amount: 1200 },
  { id: '103', clientName: 'Charlie Brown', vehicleId: '2', startDate: '2023-10-01', endDate: '2023-10-05', duration_days: 4, status: 'Completed', total_amount: 300 },
  { id: '104', clientName: 'David Lee', vehicleId: '3', startDate: '2023-11-01', endDate: '2023-11-03', duration_days: 2, status: 'Pending', total_amount: 500 },
  { id: '105', clientName: 'Sarah Connor', vehicleId: '4', startDate: '2023-09-10', endDate: '2023-09-15', duration_days: 5, status: 'Late', total_amount: 850 },
  { id: '106', clientName: 'Mike Ross', vehicleId: '6', startDate: '2023-10-15', endDate: '2023-10-22', duration_days: 7, status: 'Late', total_amount: 620 },
];
